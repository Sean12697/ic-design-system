...
export const snippetsDefault = [
  {
    ...
    snippet: `<ic-switch label="Unlimited coffee" />`,
  },
  {
    language: "React",
...
export const snippetsState = [
  {
    language: "Web component",
    snippet: `<ic-switch label="Unlimited coffee" show-state="true" />`,
  },
  {
    language: "React",
...
export const snippetsSmall = [
  {
    language: "Web component",
    snippet: `<ic-switch label="Unlimited coffee" show-state="true" small="true" />`,
  },
  {
    language: "React",
...
export const snippetsDisabled = [
  {
    language: "Web component",
    snippet: `<ic-switch label="Unlimited coffee" show-state="true" disabled="true" />
<ic-switch label="Unlimited coffee" show-state="true" disabled="true" checked="true" />`,
  },
  {
    language: "React",
