...
export const snippets = [
  {
    ...
    snippet: `<ic-skeleton variant="circle" height="20" />
...
export const snippetsLight = [
  {
    language: "Web component",
    snippet: `<ic-skeleton variant="circle" height="20" light="true" />
<ic-typography variant="caption">
  <ic-skeleton variant="text" light="true" />
</ic-typography>
<ic-skeleton light="true" />`,
  },
  {
    language: "React",
