...
export const snippets = [
  ...
  <ic-breadcrumb current="true" page-title="Coffee" href="#" />
</ic-breadcrumb-group>`,
  },
  {
    language: "React",
...
export const slottedLinks = [
  {
    language: "Web component",
    snippet: `<ic-breadcrumb-group>
  <ic-breadcrumb page-title="home">
    <ic-link>
      <a slot="router-item" href="#">Home</a>
    </ic-link>
  </ic-breadcrumb>
  <ic-breadcrumb page-title="beverages">
    <ic-link>
      <a slot="router-item" href="#">Beverages</a>
    </ic-link>
  </ic-breadcrumb>
  <ic-breadcrumb current="true" page-title="coffee">Coffee</ic-breadcrumb>
</ic-breadcrumb-group>`,
  },
  {
    language: "React",
...
<ComponentPreview snippets={slottedLinks}>
  <IcBreadcrumbGroup>
    <IcBreadcrumb pageTitle="Home" href="#" />
    <IcBreadcrumb pageTitle="Beverages" href="# " />
...
export const withIcons = [
  {
    language: "Web component",
    snippet: `<ic-breadcrumb-group>
  <ic-breadcrumb pageTitle="Home" href="#">
    <svg slot="icon">...</svg>
  </ic-breadcrumb>
  <ic-breadcrumb pageTitle="Beverages" href="#">
    <svg slot="icon">...</svg>
  </ic-breadcrumb>
  <ic-breadcrumb pageTitle="Coffee" href="#" current="true">
    <svg slot="icon">...</svg>
  </ic-breadcrumb>
</ic-breadcrumb-group>`,
  },
