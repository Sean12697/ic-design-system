...
export const snippets = [
  {
    ...
    <ic-radio-option value="crisps" label="Crisps" />
    <ic-radio-option
      value="cookie"
      ...
      inactive="true" 
    />
    <ic-radio-option value="fruit" label="Banana" />
    <ic-radio-option value="No item" label="No thanks, just my coffee" />
</ic-radio-group>`,
  },
  {
    language: "React",
...
>
  <ic-radio-option value="request" label="Yes, I want to modify my order" />
  <ic-radio-option value="none" label="No, standard please" />
</ic-radio-group>`,
  },
  {
    language: "React",
...
export const withValidation = [
  ...
  {
    language: "React",
    snippet: `<IcRadioGroup label="Do you have any special requests?" validation-status="error" validation-text="An answer to this question is required" required>
  <IcRadioOption value="request" label="Yes, I want to modify my order" />
  <IcRadioOption value="none" label="No, standard please" />
</IcRadioGroup>`,
  },
