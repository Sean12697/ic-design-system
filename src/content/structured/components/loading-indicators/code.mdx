...
export const snippetsLight = [
  {
    language: "Web component",
    snippet: `<ic-loading-indicator type="circular" name="Loading" appearance="light"/>
<ic-loading-indicator type="linear" name="Loading" appearance="light"/>`,
  },
  {
    language: "React",
...
export const snippetsChangingLabel = [
  {
    language: "Web component",
    snippet: `<ic-loading-indicator type="circular" label="Loading.../Still loading..." label-duration="4000"/>`,
  },
  {
    language: "React",
